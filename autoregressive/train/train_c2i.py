...
def main(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        for x, y in loader:
            ...
            z_indices = z_indices.reshape(x.shape[0], latent_size, latent_size)
            z_indices = z_indices.reshape(x.shape[0], sub_num, latent_size//sub_num, sub_num, latent_size//sub_num)
            z_indices = z_indices.permute(0, 2, 4, 1, 3)
